...
(() => {
    ...
    function renderProjects(container, projects) {
        const projectItems = projects.map(p => `
            <li class="project" data-reveal>
                <div class="project__art">
                    <img src="${esc(p.illustration || p.image)}" alt="" />
                </div>
        ...
        const viewAllCard = `
            <li class="project project--view-all" data-reveal>
                <a href="projects/index.html" class="project__view-all-link" aria-label="View all projects in archive">
                    <div class="project__art project__art--archive">
                        <div class="project__archive-badge">
                    ...
                    <div class="project__num">00</div>
                    <div class="project__main">
                        <div class="project__head">
                            <h3 class="project__title">All Projects<br><span class="project__title-sub">&amp; Archive</span></h3>
                            <span class="project__tag project__tag--accent">Complete Catalogue</span>
                        </div>
                        <p class="project__desc">
                            Explore all 15+ civic builds, disaster hardware, transit tools, open-source repos, and security disclosures.
                        </p>
                        <div class="project__chips">
                    ...
                    <div class="project__view-all-action">
        ...
        container.innerHTML = projectItems + viewAllCard;
    }
