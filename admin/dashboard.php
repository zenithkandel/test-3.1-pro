  ...
  <style>
    ...
    *::after {
    ...
    .upload-zone.dragover {
      border-color: var(--sienna);
      background: rgba(188, 113, 85, 0.04);
    }
...
<body>
  ...
  <div class="main">
    ...
    <div class="panel active" id="panel-meta">
      <div class="panel__head">
        <div>
          <div class="panel__title">Meta / SEO</div>
          <div class="panel__subtitle">Page title, description, Open Graph tags</div>
        </div>
      </div>
      <div class="form-grid">
    ...
    <div class="panel" id="panel-brand">
      <div class="panel__head">
        <div>
          ...
          <div class="panel__subtitle">Name, initials, tagline, loader text</div>
        </div>
      </div>
      <div class="form-grid">
        <div class="form-group"><label class="form-label">Full Name</label>
          <input class="form-input" data-path="brand.name">
        </div>
        <div class="form-group"><label class="form-label">Initials</label>
          <input class="form-input" data-path="brand.initials" maxlength="3">
        </div>
        <div class="form-group form-group--full"><label class="form-label">Tagline</label>
          <input class="form-input" data-path="brand.tagline">
        </div>
        <div class="form-group"><label class="form-label">Loader Text</label>
          <input class="form-input" data-path="brand.loaderText">
        </div>
        <div class="form-group"><label class="form-label">Home Href</label>
          <input class="form-input" data-path="brand.homeHref">
        </div>
      </div>
      <div class="btn-row"><button class="btn btn--primary" onclick="saveSection()">Save Changes</button></div>
    </div>
    ...
    <div class="panel" id="panel-hero">
      <div class="panel__head">
        <div>
          <div class="panel__title">Hero Section</div>
          <div class="panel__subtitle">Name, subtitle, portrait, CTAs, metadata</div>
        </div>
      </div>
      <div class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group"><label class="form-label">First Name</label>
            <input class="form-input" data-path="hero.firstName">
          </div>
          <div class="form-group"><label class="form-label">Last Name</label>
            <input class="form-input" data-path="hero.lastName">
          </div>
          <div class="form-group form-group--full"><label class="form-label">Subtitle</label>
            <textarea class="form-textarea" rows="3" data-path="hero.subtitle"></textarea>
          </div>
          <div class="form-group form-group--full"><label class="form-label">Availability Chip</label>
            <input class="form-input" data-path="hero.chip">
          </div>
          <div class="form-group"><label class="form-label">Location</label>
            <input class="form-input" data-path="hero.location">
          </div>
          <div class="form-group"><label class="form-label">Clock Aria Label</label>
            <input class="form-input" data-path="hero.clockAriaLabel">
          </div>
        </div>
      </div>
      <div class="form-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-group"><label class="form-label">Alt Text</label>
            <input class="form-input" data-path="hero.portrait.alt">
          </div>
          <div class="form-group"><label class="form-label">Caption</label>
            <input class="form-input" data-path="hero.portrait.caption">
          </div>
        </div>
      </div>
      <div class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Primary CTA Text</label>
            <input class="form-input" data-path="hero.ctaPrimary.text">
          </div>
          <div class="form-group"><label class="form-label">Primary CTA Href</label>
            <input class="form-input" data-path="hero.ctaPrimary.href">
          </div>
          <div class="form-group"><label class="form-label">Secondary CTA Text</label>
            <input class="form-input" data-path="hero.ctaSecondary.text">
          </div>
          <div class="form-group"><label class="form-label">Secondary CTA Href</label>
            <input class="form-input" data-path="hero.ctaSecondary.href">
          </div>
        </div>
      </div>
      <div class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Born</label>
            <input class="form-input" data-path="hero.born">
          </div>
          <div class="form-group"><label class="form-label">School</label>
            <input class="form-input" data-path="hero.school">
          </div>
          <div class="form-group"><label class="form-label">Scroll Text</label>
            <input class="form-input" data-path="hero.scrollText">
          </div>
        </div>
      </div>
      <div class="btn-row"><button class="btn btn--primary" onclick="saveSection()">Save Changes</button></div>
    ...
    <div class="panel" id="panel-marquee">
      <div class="panel__head">
        <div>
          <div class="panel__title">Marquee Strip</div>
          <div class="panel__subtitle">Scrolling text items between hero and about</div>
        </div>
      </div>
    ...
    <div class="panel" id="panel-about">
      <div class="panel__head">
        <div>
          <div class="panel__title">About Section</div>
          <div class="panel__subtitle">Section heading, bio paragraphs, feature cards</div>
        </div>
      </div>
      <div class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Section Index</label>
            <input class="form-input" data-path="about.index">
          </div>
    ...
    <div class="panel" id="panel-work">
      <div class="panel__head">
        <div>
          <div class="panel__title">Work / Projects</div>
          <div class="panel__subtitle">Section header, ornament, and project list</div>
        </div>
      </div>
      <div class="form-section">
        <div class="form-section__title">Header</div>
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Section Index</label>
            <input class="form-input" data-path="work.index">
          </div>
          <div class="form-group form-group--full"><label class="form-label">Title Lines (JSON array)</label>
            <textarea class="form-textarea" rows="2" id="workTitleEditor"></textarea>
          </div>
          <div class="form-group form-group--full"><label class="form-label">Intro Paragraph</label>
            <textarea class="form-textarea" rows="3" data-path="work.intro"></textarea>
          </div>
    ...
    <div class="panel" id="panel-stack">
      <div class="panel__head">
        <div>
          <div class="panel__title">Stack / Skills</div>
          <div class="panel__subtitle">Skill categories and tools</div>
        </div>
      </div>
      <div class="form-section">
        <div class="form-section__title">Header</div>
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Section Index</label>
            <input class="form-input" data-path="stack.index">
          </div>
          <div class="form-group form-group--full"><label class="form-label">Title Lines (JSON array)</label>
            <textarea class="form-textarea" rows="2" id="stackTitleEditor"></textarea>
          </div>
          <div class="form-group form-group--full"><label class="form-label">Intro Paragraph</label>
            <textarea class="form-textarea" rows="3" data-path="stack.intro"></textarea>
          </div>
    ...
    <div class="panel" id="panel-research">
      <div class="panel__head">
        <div>
          <div class="panel__title">Research / Disclosures</div>
          <div class="panel__subtitle">Security research section and disclosure cards</div>
        </div>
      </div>
      <div class="form-section">
        <div class="form-section__title">Header</div>
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Section Index</label>
            <input class="form-input" data-path="research.index">
          </div>
          <div class="form-group form-group--full"><label class="form-label">Title Lines (JSON array)</label>
            <textarea class="form-textarea" rows="2" id="researchTitleEditor"></textarea>
          </div>
          <div class="form-group form-group--full"><label class="form-label">Intro Paragraph</label>
            <textarea class="form-textarea" rows="3" data-path="research.intro"></textarea>
          </div>
          <div class="form-group form-group--full"><label class="form-label">Emblem SVG</label>
    ...
    <div class="panel" id="panel-contact">
      <div class="panel__head">
        <div>
          <div class="panel__title">Contact Section</div>
          <div class="panel__subtitle">Contact fields, social links, CTA button</div>
        </div>
      </div>
      <div class="form-section">
        <div class="form-section__title">Header</div>
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Section Index</label>
            <input class="form-input" data-path="contact.index">
          </div>
          <div class="form-group form-group--full"><label class="form-label">Title Lines (JSON array)</label>
            <textarea class="form-textarea" rows="2" id="contactTitleEditor"></textarea>
          </div>
          <div class="form-group form-group--full"><label class="form-label">Intro Paragraph</label>
            <textarea class="form-textarea" rows="3" data-path="contact.intro"></textarea>
          </div>
          <div class="form-group form-group--full"><label class="form-label">Emblem SVG</label>
      ...
      <div class="form-section">
        ...
        <div class="btn-row"><button class="btn btn--ghost btn--sm" onclick="addContactField()">+ Add Field</button>
        </div>
      </div>
      <div class="form-section">
    ...
    <div class="panel" id="panel-footer">
      <div class="panel__head">
        <div>
          <div class="panel__title">Footer & Navigation</div>
          <div class="panel__subtitle">Footer content, copyright, nav links</div>
        </div>
      </div>
      <div class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group"><label class="form-label">Brand Name</label>
            <input class="form-input" data-path="footer.brand">
          </div>
          <div class="form-group"><label class="form-label">Role</label>
            <input class="form-input" data-path="footer.role">
          </div>
          <div class="form-group form-group--full"><label class="form-label">Copyright</label>
            <input class="form-input" data-path="footer.copyright">
          </div>
          <div class="form-group"><label class="form-label">Version</label>
            <input class="form-input" data-path="footer.version">
          </div>
        </div>
      </div>
      <div class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group"><label class="form-label">CTA Text</label>
            <input class="form-input" data-path="nav.cta">
          </div>
          <div class="form-group"><label class="form-label">CTA Href</label>
            <input class="form-input" data-path="nav.ctaHref">
          </div>
          <div class="form-group"><label class="form-label">Menu Aria Label</label>
            <input class="form-input" data-path="nav.menuAriaLabel">
          </div>
        </div>
      </div>
      <div class="btn-row"><button class="btn btn--primary" onclick="saveSection()">Save Changes</button></div>
    ...
    <div class="panel" id="panel-files">
      <div class="panel__head">
        <div>
          <div class="panel__title">File Browser</div>
          <div class="panel__subtitle">Upload, browse, and manage files in assets/</div>
        </div>
      </div>

      <!-- Upload -->
      <div class="fb-upload">
        <div class="fb-upload__target">
          <select class="form-select" id="uploadFolder" style="width:auto">
        ...
        <div class="upload-zone" id="dropZone">
          <input type="file" id="fileInput" accept=".jpg,.jpeg,.png,.gif,.webp,.svg" multiple>
          <div class="upload-zone__text">Drop files here or <strong>click to browse</strong></div>
          <div class="upload-zone__hint">jpg, png, gif, webp, svg &mdash; max 10MB each</div>
        </div>
      ...
      <div class="fb-browse">
        ...
        <div id="fileListEmpty" class="fb-empty" style="display:none">No files in this folder</div>
      </div>
    </div>
    ...
    <div class="panel" id="panel-json">
      <div class="panel__head">
        <div>
          <div class="panel__title">Raw JSON Editor</div>
          <div class="panel__subtitle">Edit data.json directly &mdash; backups are created automatically</div>
        </div>
      </div>
  ...
  <script>
    ...
    function populateAll() {
      ...
      populateRawJson();
      /* Init image pickers */
      createImagePicker('picker-hero-portrait', { folder: 'images', accept: '.jpg,.jpeg,.png,.webp', inputId: 'heroPortraitSrc' });
      createImagePicker('picker-work-ornament', { folder: 'svg/emblems', accept: '.svg', inputId: 'workOrnament' });
      createImagePicker('picker-stack-emblem', { folder: 'svg/emblems', accept: '.svg', inputId: 'stackEmblem' });
      createImagePicker('picker-research-emblem', { folder: 'svg/emblems', accept: '.svg', inputId: 'researchEmblem' });
      createImagePicker('picker-contact-emblem', { folder: 'svg/emblems', accept: '.svg', inputId: 'contactEmblem' });
    }
